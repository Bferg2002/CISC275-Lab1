...
const yourName : String = "Bryant Ferguson";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "junior";
let oneExcite : String = "I am excited to learn about software engineering";
let anyConcerns : String = "I do not really have any concerns."
